...
const ElegantSelect: React.FC<ElegantSelectProps> = ({
  value,
  onChange,
  options,
  ...
  const handleOptionClick = (option: ElegantSelectOption) => {
    onChange(option.value);
    setIsOpen(false);
    setHighlightedIndex(-1);
  };

  const handleOptionKeyDown = (e: React.KeyboardEvent, option: ElegantSelectOption) => {
