...
type Account struct {
	...
	AccountType string     `json:"account_type" db:"account_type"` // Conta Corrente, Conta Poupança, etc.
...
type CreateAccountRequest struct {
	...
	AccountType    string  `json:"account_type"`                                 // Conta Corrente, Conta Poupança, etc.
